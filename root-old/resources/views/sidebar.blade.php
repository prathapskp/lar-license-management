<div id="main-menu" role="navigation">
    <div id="main-menu-inner">
      ...
      <ul class="navigation">
        <li><!-- class="active" -->
          <a href="home.html"><i class="menu-icon fa fa-dashboard"></i><span class="mm-text">Dashboard</span></a>
        </li>
        <li>
      ...
      <div class="menu-content">
        <a href="#" class="btn btn-primary btn-block btn-outline dark">Make a Renewal</a>
      </div>
    </div> <!-- / #main-menu-inner -->
  </div> <!-- / #main-menu -->
<!-- /4. $MAIN_MENU -->