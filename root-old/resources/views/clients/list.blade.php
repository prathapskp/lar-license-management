   ...
   <ul class="breadcrumb breadcrumb-page">
		...
		<div class="page-header">
			...
			<div class="row">
				...
				<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Dashboard > clients</h1>

				<div class="col-xs-12 col-sm-8">
					<div class="row">
						<hr class="visible-xs no-grid-gutter-h">
						<!-- "Create project" button, width=auto on desktops -->
						<div class="pull-right col-xs-12 col-sm-auto"><a href="{{ url('clients/create') }}" class="btn btn-primary btn-labeled" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Add Client</a></div>
...
-->
	...
	/*$('#fileData').dataTable( {
			...
			'sAjaxSource'    : ' {{ url('clients/ajaxData') }}',
			'fnServerData': function(sSource, aoData, fnCallback) {
			//	aoData.push( { "_token": token } );
