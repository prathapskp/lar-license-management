   ...
   <ul class="breadcrumb breadcrumb-page">
    ...
    <div class="page-header">
      ...
      <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;{{ trans('vehicle.renewal_license_page') }}</h1>
...
-->
  ...
  //  var token = "{{ csrf_token() }}";
    $('#fileData').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ url('vehicle/renewal_listing_ajax_data') }}",
        "columns": [
