...
<div class="page-header">
	...
	<div class="panel">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="redirect_to" value="/vehicle/renewal-listing">
			<div class="box-body">
			...
			<div class="box-footer pull-right">
				<a href="{{ url('vehicle/renewal-listing') }}"><button type="button" class="btn btn-default">{{ trans('vehicle.form_cancel_button') }}</button></a>
