   ...
   <ul class="breadcrumb breadcrumb-page">
		...
		<div class="page-header">
			...
			<div class="row">
				...
				<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;{{ trans('license_type.listing_page_heading') }}</h1>

				<div class="col-xs-12 col-sm-8">
					<div class="row">
						<hr class="visible-xs no-grid-gutter-h">
						<!-- "Create project" button, width=auto on desktops -->
						<div class="pull-right col-xs-12 col-sm-auto"><a href="{{ url('license-type/create') }}" class="btn btn-primary btn-labeled" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>{{ trans('license_type.add_vehicle') }}</a></div>
...
-->
	...
	//	var token = "{{ csrf_token() }}";
	  $('#fileData').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ url('license-types/ajaxData') }}",
        "columns": [
            {data: 'type', name: 'type'},		  
